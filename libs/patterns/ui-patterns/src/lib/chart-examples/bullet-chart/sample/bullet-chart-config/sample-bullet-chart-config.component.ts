...
import {NgPatBulletChartConfig} from '@ngpat/charts/bullet-chart';
...
export class SampleBulletChartConfigComponent implements OnInit {
  ...
  @Output()
  configChange: EventEmitter<NgPatBulletChartConfig> = new EventEmitter();
  ...
  constructor(private _fb: FormBuilder, private _cd: ChangeDetectorRef) {
    this.configForm = this._fb.group({
      ...
      maxTooltipWidth: new FormControl(
        bulletChartConfigInitial.maxTooltipWidth
      ),
  ...
  ngOnInit(): void {
    ...
    this.configForm.valueChanges.subscribe((c: NgPatBulletChartConfig) => {
