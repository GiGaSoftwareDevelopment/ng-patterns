...
interface NormalizedSchema extends AddAppToDomainGeneratorSchema {
  projectName: string;
  projectRoot: string;
...
function normalizeOptions(tree: Tree, options: AddAppToDomainGeneratorSchema): NormalizedSchema {
