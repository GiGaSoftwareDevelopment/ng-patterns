...
import { NgrxEntityGeneratorSchema, SchematicOptions } from './schema';
...
export default async function (tree: Tree, schema: NgrxEntityGeneratorSchema) {
  const options = {
 ...
 */
function normalizeOptions(options: NgrxEntityGeneratorSchema): SchematicOptions {
  return {
    ...options,
