...
export default async function (tree: Tree, schema: FeatureComponentGeneratorSchema) {
  const options = {
 ...
 */
function normalizeOptions(options: FeatureComponentGeneratorSchema): SchematicOptions {
  return {
    ...options,
